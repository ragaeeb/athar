...
import { BASE_PLAYER_SPEED_METERS_PER_SECOND } from '@/lib/constants';
import { atharDebugLog } from '@/lib/debug';
import { getLastManualMapInteractionAt, recordCameraFollow, recordCameraFollowCooldownSkip } from '@/lib/perf-metrics';
import { resolveCameraFollow, shouldAutoFollowCamera } from './player-motion';
