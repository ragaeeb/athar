...
export const PLAYER_RUN_SPEED_MULTIPLIER = 1.75;
export const PLAYER_RUN_MAX_CHARGE_MS = 2_500;
export const PLAYER_RUN_RECHARGE_MS = 4_500;
export const PLAYER_RUN_MIN_START_CHARGE_FRACTION = 1;
