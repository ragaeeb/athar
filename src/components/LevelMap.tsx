...
import { HadithToken } from '@/game/entities/HadithToken';
import { Milestone3DBuilding } from '@/game/entities/Milestone3DBuilding';
import { ObstacleEntity } from '@/game/entities/ObstacleEntity';
import { PlayerCharacter } from '@/game/entities/PlayerCharacter';
import { TeacherNPC } from '@/game/entities/TeacherNPC';
import type { LevelConfig } from '@/game/levels/level.types';
import { useLevelStore } from '@/game/store/level.store';
import { usePlayerStore } from '@/game/store/player.store';
import { MAP_LABEL_FONT_SIZE } from '@/lib/constants';
